...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (window.Swal && !window.Swal.__core3StatusThemeInstalled) {
        ...
        window.Swal.fire = function (...args) {
            ...
            const motion = {showClass:{popup:'core3-dialog-in'},hideClass:{popup:'core3-dialog-out'}};
            const statusIconHtml={success:'<i class="fa-solid fa-check"></i>',error:'<i class="fa-solid fa-xmark"></i>',warning:'<i class="fa-solid fa-exclamation"></i>',info:'<i class="fa-solid fa-info"></i>',question:'<i class="fa-solid fa-question"></i>'};
